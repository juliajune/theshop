...
const stepperBtnUp = stepper.querySelector('.stepper__button_up');
const stepperBtnDown = stepper.querySelector('.stepper__button_down');
...
stepperInput.addEventListener('keyup', (e) => {
	...
	if (count == 1) {
		stepperBtnDown.classList.add('stepper__button_disabled');
	} else {
		stepperBtnDown.classList.remove('stepper__button_disabled');
	}
});
